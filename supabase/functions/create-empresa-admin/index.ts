...
const DEFAULT_COST_ITEMS = [
  ...
  { name: 'Abaixador de língua', category: 'material', unit: 'un', unit_cost: 0.15 },
  { name: 'Abocath', category: 'material', unit: 'un', unit_cost: 3.50 },
  { name: 'Acetona', category: 'material', unit: 'un', unit_cost: 6.00 },
  { name: 'Agulha', category: 'material', unit: 'un', unit_cost: 0.25 },
  { name: 'Álcool 1L', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Algodão', category: 'material', unit: 'un', unit_cost: 6.00 },
  { name: 'Atadura', category: 'material', unit: 'un', unit_cost: 1.20 },
  { name: 'Avental descartável', category: 'material', unit: 'un', unit_cost: 3.00 },
  { name: 'Cadarço', category: 'material', unit: 'un', unit_cost: 2.00 },
  { name: 'Cateter nasal', category: 'material', unit: 'un', unit_cost: 2.50 },
  { name: 'Cateter óculos', category: 'material', unit: 'un', unit_cost: 4.00 },
  { name: 'Clorexidina', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Coletor de secreções', category: 'material', unit: 'un', unit_cost: 12.00 },
  { name: 'Coletor de urina', category: 'material', unit: 'un', unit_cost: 3.50 },
  { name: 'Descarpack', category: 'material', unit: 'un', unit_cost: 10.00 },
  { name: 'Eletrodos', category: 'material', unit: 'un', unit_cost: 1.20 },
  { name: 'Equipo 2 vias', category: 'material', unit: 'un', unit_cost: 3.50 },
  { name: 'Equipo macrogotas', category: 'material', unit: 'un', unit_cost: 2.80 },
  { name: 'Esparadrapo', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Fio catgut', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Fio sutura', category: 'material', unit: 'un', unit_cost: 7.00 },
  { name: 'Gaze estéril', category: 'material', unit: 'un', unit_cost: 0.80 },
  { name: 'Gel para eletro', category: 'material', unit: 'un', unit_cost: 9.00 },
  { name: 'Kit obstétrico', category: 'material', unit: 'un', unit_cost: 60.00 },
  { name: 'Lâmina bisturi', category: 'material', unit: 'un', unit_cost: 1.20 },
  { name: 'Lanceta', category: 'material', unit: 'un', unit_cost: 0.30 },
  { name: 'Lençol descartável', category: 'material', unit: 'un', unit_cost: 3.00 },
  { name: 'Luva estéril', category: 'material', unit: 'un', unit_cost: 3.50 },
  { name: 'Luva procedimento', category: 'material', unit: 'un', unit_cost: 0.40 },
  { name: 'Manta térmica', category: 'material', unit: 'un', unit_cost: 18.00 },
  { name: 'Máscara proteção', category: 'material', unit: 'un', unit_cost: 0.80 },
  { name: 'Micropore', category: 'material', unit: 'un', unit_cost: 6.00 },
  { name: 'Kit nebulização', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Papel ECG', category: 'material', unit: 'un', unit_cost: 35.00 },
  { name: 'Pilhas', category: 'material', unit: 'un', unit_cost: 3.00 },
  { name: 'Povidine', category: 'material', unit: 'un', unit_cost: 12.00 },
  { name: 'Saco lixo hospitalar', category: 'material', unit: 'un', unit_cost: 1.80 },
  { name: 'Scalp', category: 'material', unit: 'un', unit_cost: 1.20 },
  { name: 'Seringa', category: 'material', unit: 'un', unit_cost: 0.80 },
  { name: 'Sonda aspiração', category: 'material', unit: 'un', unit_cost: 2.50 },
  { name: 'Sonda Foley', category: 'material', unit: 'un', unit_cost: 8.00 },
  { name: 'Sonda uretral', category: 'material', unit: 'un', unit_cost: 3.00 },
  { name: 'Tala imobilização', category: 'material', unit: 'un', unit_cost: 18.00 },
  { name: 'Tubo endotraqueal', category: 'material', unit: 'un', unit_cost: 9.00 },
  { name: 'Vaselina', category: 'material', unit: 'un', unit_cost: 6.00 },
]
